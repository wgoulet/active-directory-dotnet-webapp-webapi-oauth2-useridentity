...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KeyItem :  IEquatable<KeyItem>, IValidatableObject
    {
        /// <summary>
        ...
        public KeyItem(string Kid = default(string), KeyAttributes Attributes = default(KeyAttributes), Dictionary<string, string> Tags = default(Dictionary<string, string>))
        {
            this.Kid = Kid;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as KeyItem);
        }

        /// <summary>
        /// Returns true if KeyItem instances are equal
        /// </summary>
        /// <param name="other">Instance of KeyItem to be compared</param>
        /// <returns>Boolean</returns>
