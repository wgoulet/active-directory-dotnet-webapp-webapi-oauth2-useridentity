...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CertificateItem :  IEquatable<CertificateItem>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CertificateItem" /> class.
        /// </summary>
        ...
        public CertificateItem(string Id = default(string), CertificateAttributes Attributes = default(CertificateAttributes), Dictionary<string, string> Tags = default(Dictionary<string, string>), string X5t = default(string))
        {
            this.Id = Id;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CertificateItem);
        }

        /// <summary>
        /// Returns true if CertificateItem instances are equal
        /// </summary>
        /// <param name="other">Instance of CertificateItem to be compared</param>
        /// <returns>Boolean</returns>
