...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StorageListResult :  IEquatable<StorageListResult>, IValidatableObject
    {
        /// <summary>
        ...
        public StorageListResult(List<StorageAccountItem> Value = default(List<StorageAccountItem>))
        {
            this.Value = Value;
        }
        ...
        /// </summary>
        /// <value>A response message containing a list of storage accounts in the key vault along with a link to the next page of storage accounts.</value>
        [DataMember(Name="value", EmitDefaultValue=false)]
        public List<StorageAccountItem> Value { get; set; }

        /// <summary>
        /// The URL to get the next set of storage accounts.
        /// </summary>
        /// <value>The URL to get the next set of storage accounts.</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as StorageListResult);
        }

        /// <summary>
        /// Returns true if StorageListResult instances are equal
        /// </summary>
        /// <param name="other">Instance of StorageListResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StorageListResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
