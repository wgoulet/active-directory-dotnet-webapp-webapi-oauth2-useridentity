...
namespace IO.Swagger.Model
{
    ...
    public partial class CertificateBundle :  IEquatable<CertificateBundle>, IValidatableObject
    {
        ...
        public CertificateBundle(CertificatePolicy Policy = default(CertificatePolicy), byte[] Cer = default(byte[]), string ContentType = default(string), CertificateAttributes Attributes = default(CertificateAttributes), Dictionary<string, string> Tags = default(Dictionary<string, string>))
        {
            this.Policy = Policy;
            this.Cer = Cer;
