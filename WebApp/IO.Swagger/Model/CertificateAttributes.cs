...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CertificateAttributes : Attributes,  IEquatable<CertificateAttributes>, IValidatableObject
    {
        /// <summary>
        ...
        public CertificateAttributes(bool? Enabled = default(bool?), int? Nbf = default(int?), int? Exp = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CertificateAttributes);
        }
