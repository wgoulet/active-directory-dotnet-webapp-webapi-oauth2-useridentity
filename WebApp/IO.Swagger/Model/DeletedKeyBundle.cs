...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DeletedKeyBundle : KeyBundle,  IEquatable<DeletedKeyBundle>, IValidatableObject
    {
        /// <summary>
        ...
        public DeletedKeyBundle(JsonWebKey Key = default(JsonWebKey), KeyAttributes Attributes = default(KeyAttributes), Dictionary<string, string> Tags = default(Dictionary<string, string>))
        {
            this.Key = Key;
