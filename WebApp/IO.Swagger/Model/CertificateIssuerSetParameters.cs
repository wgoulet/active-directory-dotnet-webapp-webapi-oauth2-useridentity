...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CertificateIssuerSetParameters :  IEquatable<CertificateIssuerSetParameters>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CertificateIssuerSetParameters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CertificateIssuerSetParameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CertificateIssuerSetParameters" /> class.
        /// </summary>
        /// <param name="Provider">The issuer provider. (required).</param>
        ...
        public CertificateIssuerSetParameters(string Provider = default(string), IssuerCredentials Credentials = default(IssuerCredentials), OrganizationDetails OrgDetails = default(OrganizationDetails), IssuerAttributes Attributes = default(IssuerAttributes))
        {
            // to ensure "Provider" is required (not null)
            if (Provider == null)
            {
                throw new InvalidDataException("Provider is a required property for CertificateIssuerSetParameters and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CertificateIssuerSetParameters);
        }

        /// <summary>
        /// Returns true if CertificateIssuerSetParameters instances are equal
        /// </summary>
        /// <param name="other">Instance of CertificateIssuerSetParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CertificateIssuerSetParameters other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
