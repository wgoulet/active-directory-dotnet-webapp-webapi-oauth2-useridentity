...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class KeySignParameters :  IEquatable<KeySignParameters>, IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The signing/verification algorithm identifier. For more information on possible algorithm types, see JsonWebKeySignatureAlgorithm.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KeySignParameters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KeySignParameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KeySignParameters" /> class.
        /// </summary>
        /// <param name="Alg">The signing/verification algorithm identifier. For more information on possible algorithm types, see JsonWebKeySignatureAlgorithm. (required).</param>
        /// <param name="Value">Value (required).</param>
        public KeySignParameters(AlgEnum? Alg = default(AlgEnum?), string Value = default(string))
        {
            // to ensure "Alg" is required (not null)
            if (Alg == null)
            {
                throw new InvalidDataException("Alg is a required property for KeySignParameters and cannot be null");
            }
            else
            {
                this.Alg = Alg;
            ...
            if (Value == null)
            {
                throw new InvalidDataException("Value is a required property for KeySignParameters and cannot be null");
            }
            else
            {
                this.Value = Value;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as KeySignParameters);
        }

        /// <summary>
        /// Returns true if KeySignParameters instances are equal
        /// </summary>
        /// <param name="other">Instance of KeySignParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeySignParameters other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
